...
class TestPlan:
    ...
    def handle_additional_scripts(self, platform_name: Platform, testsuite: TestInstance):
        matched_scripting = self.scripting.get_matched_scripting(testsuite, platform_name)
