...
class TestPlan:
    ...
    def load(self):
        ...
        if self.scripting:
            ...
            for instance in self.instances.values():
                self.handle_additional_scripts(instance.platform.name, instance.testsuite.id, was_script_matched)
    ...
    def handle_additional_scripts(self, platform_name: Platform, testsuide: TestInstance, was_script_matched: bool):
        matched_scripting = self.scripting.get_matched_scripting(testsuide, platform_name)
        if matched_scripting:
            was_script_matched = True
